...
- **收尾修复（final fix wave）**：
  ...
  - **I2 概念 tab 口径声明**：`HotSectors` 概念分类文案改为「概念板块涨跌幅与家数按本地成分聚合，每日 18:20 刷新」（展示的是成分均值 `avg_pct`，不写明会被读成东财板块涨跌幅）
